...
-- Products table (aligned with UI requirements)
...
-- Product variants table (aligned with UI requirements)
...
-- Orders table (aligned with UI requirements - this is the main sales/orders table)
...
-- Order items table (aligned with UI requirements)
...
-- Function to get order with items (for UI compatibility)
...
-- Function to get all orders with items (for UI compatibility)
